...
Bij mijn test haalde astro een performance score van 88-90 in lighthouse wat aanzienlijk hoger is dan nextjs. Daar kwam er een score van 68-76 uit.

Bij Astro kan je de performance nog meer verhogen doormiddel van 'cleint:visible'. Hierdoor word bijvoorbeeld een component pas ingeladen als die in beeld zichtbaar is.
...
- supabase: Met supabase kan je best wel eenvoudig data op slaan en ophalen via de supabase api. Ik gebruikte in mijn test voor zowel het inladen van data als het inlog systeem supabase als headless cms.
